...
| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q01](#q01-什么是前端性能优化为什么要做性能优化) | 什么是前端性能优化？为什么要做性能优化？ | ★☆☆ |
| [Q02](#q02-core-web-vitals-包含哪些指标各自含义是什么) | Core Web Vitals 包含哪些指标？各自含义是什么？ | ★☆☆ |
| [Q03](#q03-fcp-和-lcp-有什么区别) | FCP 和 LCP 有什么区别？ | ★☆☆ |
| [Q04](#q04-什么是cls累积布局偏移如何避免) | 什么是 CLS（累积布局偏移）？如何避免？ | ★☆☆ |
| [Q05](#q05-preloadprefetchpreconnect-的区别) | preload、prefetch、preconnect 的区别？ | ★☆☆ |
| [Q06](#q06-强缓存和协商缓存的区别) | 强缓存和协商缓存的区别？ | ★☆☆ |
| [Q07](#q07-cache-control-常用指令有哪些) | Cache-Control 常用指令有哪些？ | ★☆☆ |
| [Q08](#q08-async-和-defer-的区别) | async 和 defer 的区别？ | ★☆☆ |
| [Q09](#q09-什么是关键渲染路径crp) | 什么是关键渲染路径（CRP）？ | ★☆☆ |
| [Q10](#q10-什么是懒加载如何实现图片懒加载) | 什么是懒加载？如何实现图片懒加载？ | ★☆☆ |
| [Q11](#q11-什么是-tree-shaking它的原理是什么) | 什么是 Tree Shaking？它的原理是什么？ | ★☆☆ |
| [Q12](#q12-什么是防抖和节流区别是什么) | 什么是防抖和节流？区别是什么？ | ★☆☆ |
| [Q13](#q13-重排reflow-和重绘repaint-的区别如何减少) | 重排（Reflow）和重绘（Repaint）的区别？如何减少？ | ★☆☆ |
| [Q14](#q14-cdn-是什么有什么作用) | CDN 是什么？有什么作用？ | ★☆☆ |
| [Q15](#q15-gzip-压缩的原理) | gzip 压缩的原理？ | ★☆☆ |

### 进阶层（★★☆）Q16 - Q33

| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q16](#q16-从输入-url-到页面展示的完整过程中哪些环节可以优化) | 从输入 URL 到页面展示的完整过程中，哪些环节可以优化？ | ★★☆ |
| [Q17](#q17-如何优化首屏加载速度综合性问题) | 如何优化首屏加载速度？（综合性问题） | ★★☆ |
| [Q18](#q18-代码分割有哪些方式各适用于什么场景) | 代码分割有哪些方式？各适用于什么场景？ | ★★☆ |
| [Q19](#q19-service-worker-的生命周期和缓存策略) | Service Worker 的生命周期和缓存策略？ | ★★☆ |
| [Q20](#q20-虚拟列表的原理是什么如何实现一个简单的虚拟列表) | 虚拟列表的原理是什么？如何实现一个简单的虚拟列表？ | ★★☆ |
| [Q21](#q21-will-change-属性的作用和使用注意事项) | will-change 属性的作用和使用注意事项？ | ★★☆ |
| [Q22](#q22-css-containment-是什么有什么好处) | CSS Containment 是什么？有什么好处？ | ★★☆ |
| [Q23](#q23-如何检测和解决内存泄漏) | 如何检测和解决内存泄漏？ | ★★☆ |
| [Q24](#q24-web-worker-的使用场景和限制) | Web Worker 的使用场景和限制？ | ★★☆ |
| [Q25](#q25-requestanimationframe-和-settimeout-的区别) | requestAnimationFrame 和 setTimeout 的区别？ | ★★☆ |
| [Q26](#q26-大列表渲染的性能瓶颈在哪里有哪些解决方案) | 大列表渲染的性能瓶颈在哪里？有哪些解决方案？ | ★★☆ |
| [Q27](#q27-如何优化长任务的执行) | 如何优化长任务的执行？ | ★★☆ |
| [Q28](#q28-http2-相比-http11-有哪些性能提升) | HTTP/2 相比 HTTP/1.1 有哪些性能提升？ | ★★☆ |
| [Q29](#q29-图片格式选择策略jpegpngwebpavif-各自适用场景) | 图片格式选择策略（JPEG/PNG/WebP/AVIF 各自适用场景） | ★★☆ |
| [Q30](#q30-字体加载优化的最佳实践) | 字体加载优化的最佳实践？ | ★★☆ |
| [Q31](#q31-如何设计一套完整的缓存策略) | 如何设计一套完整的缓存策略？ | ★★☆ |
| [Q32](#q32-资源预加载resource-hints-的使用策略) | 资源预加载（resource hints）的使用策略？ | ★★☆ |
| [Q33](#q33-打包体积过大的排查思路和优化方案) | 打包体积过大的排查思路和优化方案？ | ★★☆ |

### 专家层（★★★）Q34 - Q50

| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q34](#q34-设计一个前端性能监控系统需要考虑哪些方面) | 设计一个前端性能监控系统，需要考虑哪些方面？ | ★★★ |
| [Q35](#q35-如何建立性能预算体系并在-ci-中落地) | 如何建立性能预算体系并在 CI 中落地？ | ★★★ |
| [Q36](#q36-ssrssgisr-对于性能优化的意义和取舍) | SSR/SSG/ISR 对于性能优化的意义和取舍？ | ★★★ |
| [Q37](#q37-微前端架构下的性能挑战和优化策略) | 微前端架构下的性能挑战和优化策略？ | ★★★ |
| [Q38](#q38-设计一个支持百万级数据的表格组件) | 设计一个支持百万级数据的表格组件 | ★★★ |
| [Q39](#q39-手写一个带取消功能的-debounce-函数) | 手写一个带取消功能的 debounce 函数 | ★★★ |
| [Q40](#q40-手写一个图片懒加载指令支持-intersectionobserver-降级) | 手写一个图片懒加载指令（支持 IntersectionObserver 降级） | ★★★ |
| [Q41](#q41-手写一个简单的-performance-collector收集核心指标并上报) | 手写一个简单的 Performance Collector（收集核心指标并上报） | ★★★ |
| [Q42](#q42-实现-lcp-的手动采集逻辑基于-performance-observer) | 实现 LCP 的手动采集逻辑（基于 Performance Observer） | ★★★ |
| [Q43](#q43-设计并实现一个前端错误性能一体化上报-sdk) | 设计并实现一个前端错误+性能一体化上报 SDK | ★★★ |
| [Q44](#q44-一个电商首页从0到1的性能优化全案) | 一个电商首页从0到1的性能优化全案 | ★★★ |
| [Q45](#q45-低端机弱网环境下的性能降级策略设计) | 低端机/弱网环境下的性能降级策略设计 | ★★★ |
| [Q46](#q46-如何量化前端优化的业务价值roi) | 如何量化前端优化的业务价值（ROI）？ | ★★★ |
| [Q47](#q47-大型-spa-应用的性能治理体系设计) | 大型 SPA 应用的性能治理体系设计 | ★★★ |
| [Q48](#q48-react-server-components-对性能优化的意义) | React Server Components 对性能优化的意义？ | ★★★ |
| [Q49](#q49-edge-computing-在前端性能优化中的应用前景) | Edge Computing 在前端性能优化中的应用前景？ | ★★★ |
| [Q50](#q50-如何看待-ai-辅助的前端性能优化工具) | 如何看待 AI 辅助的前端性能优化工具？ | ★★★ |
