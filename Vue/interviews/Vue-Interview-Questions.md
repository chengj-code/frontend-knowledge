...
> **快速导航**：点击题目即可跳转到对应位置 | 共 **45** 道题

### 基础层（★☆☆）Q01 - Q15

| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q01](#q01-请简述-vue-的模板语法主要包含哪些类型分别举例说明) | 请简述 Vue 的模板语法主要包含哪些类型？分别举例说明。 | ★☆☆ |
| [Q02](#q02-v-if-和-v-show-有什么区别在什么场景下选择哪个) | v-if 和 v-show 有什么区别？在什么场景下选择哪个？ | ★☆☆ |
| [Q03](#q03-v-for-中的-key-有什么作用为什么推荐使用唯一-id-作为-key) | v-for 中的 key 有什么作用？为什么推荐使用唯一 ID 作为 key？ | ★☆☆ |
| [Q04](#q04-vue-中常用的指令有哪些请分类说明) | Vue 中常用的指令有哪些？请分类说明。 | ★☆☆ |
| [Q05](#q05-v-model-的实现原理是什么如何在自定义组件中实现-v-model) | v-model 的实现原理是什么？如何在自定义组件中实现 v-model？ | ★☆☆ |
| [Q06](#q06-vue-组件的-data-为什么必须是一个函数) | Vue 组件的 data 为什么必须是一个函数？ | ★☆☆ |
| [Q07](#q07-请描述-vue-组件的生命周期钩子及其执行顺序) | 请描述 Vue 组件的生命周期钩子及其执行顺序。 | ★☆☆ |
| [Q08](#q08-computed-和-watch-有什么区别各自的使用场景是什么) | computed 和 watch 有什么区别？各自的使用场景是什么？ | ★☆☆ |
| [Q09](#q09-vue-中有哪些常用的组件通信方式请举例说明每种方式) | Vue 中有哪些常用的组件通信方式？请举例说明每种方式。 | ★☆☆ |
| [Q10](#q10-什么是插槽slot请说明具名插槽和作用域插槽的区别和使用场景) | 什么是插槽（Slot）？请说明具名插槽和作用域插槽的区别和使用场景。 | ★☆☆ |
| [Q11](#q11-vue-中的过滤器filter在-vue3-中被移除了应该如何替代) | Vue 中的过滤器（Filter）在 Vue3 中被移除了，应该如何替代？ | ★☆☆ |
| [Q12](#q12-vue-中如何进行样式隔离scoped-的原理是什么) | Vue 中如何进行样式隔离？scoped 的原理是什么？ | ★☆☆ |
| [Q13](#q13-如何理解-vue-的单向数据流为什么要遵循这个原则) | 如何理解 Vue 的单向数据流？为什么要遵循这个原则？ | ★☆☆ |
| [Q14](#q14-vue-中的动态组件和异步组件有什么区别如何使用) | Vue 中的动态组件和异步组件有什么区别？如何使用？ | ★☆☆ |
| [Q15](#q15-vue-中-mixins-的优缺点是什么vue3-中有什么更好的替代方案) | Vue 中 mixins 的优缺点是什么？Vue3 中有什么更好的替代方案？ | ★☆☆ |

### 进阶层（★★☆）Q16 - Q30

| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q16](#q16-请详细说明-vue2-和-vue3-响应式系统的区别) | 请详细说明 Vue2 和 Vue3 响应式系统的区别。 | ★★☆ |
| [Q17](#q17-vue3-的-composition-api-setup-函数相比-options-api-有哪些优势) | Vue3 的 Composition API（setup 函数）相比 Options API 有哪些优势？ | ★★☆ |
| [Q18](#q18-ref-和-reactive-应该如何选择有什么使用建议) | ref 和 reactive 应该如何选择？有什么使用建议？ | ★★☆ |
| [Q19](#q19-请解释-vue-的虚拟domvirtual-dom概念及其优势) | 请解释 Vue 的虚拟 DOM（Virtual DOM）概念及其优势。 | ★★☆ |
| [Q20](#q20-请详细说明-vue-的-diff-算法原理) | 请详细说明 Vue 的 diff 算法原理。 | ★★☆ |
| [Q21](#q21-vue-router-的-hash-模式和-history-模式有什么区别) | Vue Router 的 hash 模式和 history 模式有什么区别？ | ★★☆ |
| [Q22](#q22-vue-router-的导航守卫有哪些它们的执行顺序是怎样的) | Vue Router 的导航守卫有哪些？它们的执行顺序是怎样的？ | ★★☆ |
| [Q23](#q23-pinia-和-vuex-有什么区别为什么-vue-官方推荐使用-pinia) | Pinia 和 Vuex 有什么区别？为什么 Vue 官方推荐使用 Pinia？ | ★★☆ |
| [Q24](#q24-请说明-keep-alive-组件的作用和工作原理) | 请说明 keep-alive 组件的作用和工作原理。 | ★★☆ |
| [Q25](#q25-vue3-的-teleport传送门组件有什么作用使用场景有哪些) | Vue3 的 Teleport（传送门）组件有什么作用？使用场景有哪些？ | ★★☆ |
| [Q26](#q26-vue3-的-suspense-组件是什么如何使用) | Vue3 的 Suspense 组件是什么？如何使用？ | ★★☆ |
| [Q27](#q27-vue3-的-fragment片段特性解决了什么问题) | Vue3 的 Fragment（片段）特性解决了什么问题？ | ★★☆ |
| [Q28](#q28-如何理解-vue-中的依赖收集和派发更新机制) | 如何理解 Vue 中的依赖收集和派发更新机制？ | ★★☆ |
| [Q29](#q29-vue3-的-v-memo-指令是什么它如何优化性能) | Vue3 的 `v-memo` 指令是什么？它如何优化性能？ | ★★☆ |
| [Q30](#q30-vue3-中如何实现自定义-hookcomposable请给出一个完整的示例) | Vue3 中如何实现自定义 Hook（Composable）？请给出一个完整的示例。 | ★★☆ |

### 专家层（★★★）Q31 - Q45

| 题号 | 题目 | 难度 |
|:----:|------|:----:|
| [Q31](#q31-请深入分析-vue3-的-nexttick-实现原理) | 请深入分析 Vue3 的 nextTick 实现原理。 | ★★★ |
| [Q32](#q32-请深入分析-vue3-的异步更新队列调度器-scheduler的实现) | 请深入分析 Vue3 的异步更新队列（调度器 Scheduler）的实现。 | ★★★ |
| [Q33](#q33-请分析-vue3-的编译原理模板--渲染函数--vnode) | 请分析 Vue3 的编译原理（模板 → 渲染函数 → VNode）。 | ★★★ |
| [Q34](#q34-请分析-vue3-响应式系统的完整实现reactive-函数的源码逻辑) | 请分析 Vue3 响应式系统的完整实现（reactive 函数的源码逻辑）。 | ★★★ |
| [Q35](#q35-vue3-的-computed-是如何实现的请分析其缓存和依赖追踪机制) | Vue3 的 computed 是如何实现的？请分析其缓存和依赖追踪机制。 | ★★★ |
| [Q36](#q36-请列举-vue-项目中常见的性能优化手段并说明各自的适用场景) | 请列举 Vue 项目中常见的性能优化手段，并说明各自的适用场景。 | ★★★ |
| [Q37](#q37-如何设计一个高质量的-vue-组件请说明组件设计的原则和最佳实践) | 如何设计一个高质量的 Vue 组件？请说明组件设计的原则和最佳实践。 | ★★★ |
| [Q38](#q38-vue-项目如何进行工程化配置请说明-vite-配置和项目结构最佳实践) | Vue 项目如何进行工程化配置？请说明 Vite 配置和项目结构最佳实践。 | ★★★ |
| [Q39](#q39-vue3-typescript-的集成有哪些注意事项如何写出类型安全的-vue-代码) | Vue3 + TypeScript 的集成有哪些注意事项？如何写出类型安全的 Vue 代码？ | ★★★ |
| [Q40](#q40-请说明-vue-ssr服务端渲染的原理和-nuxtjs-的基本概念) | 请说明 Vue SSR（服务端渲染）的原理和 Nuxt.js 的基本概念。 | ★★★ |
| [Q41](#q41-如何设计一个-vue-插件请说明插件的开发规范和最佳实践) | 如何设计一个 Vue 插件？请说明插件的开发规范和最佳实践。 | ★★★ |
| [Q42](#q42-vue-中如何实现权限控制路由权限按钮权限) | Vue 中如何实现权限控制（路由权限 + 按钮权限）？ | ★★★ |
| [Q43](#q43-vue-项目中如何进行状态管理的设计请说明什么情况下应该使用-pinia) | Vue 项目中如何进行状态管理的设计？请说明什么情况下应该使用 Pinia。 | ★★★ |
| [Q44](#q44-vue-项目中如何进行错误处理和异常捕获) | Vue 项目中如何进行错误处理和异常捕获？ | ★★★ |
| [Q45](#q45-请设计一个-vue-微前端架构方案) | 请设计一个 Vue 微前端架构方案。 | ★★★ |
